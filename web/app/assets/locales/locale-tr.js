 module.exports = {
    ...
    operation: {
        ...
        reg_account: "{registrar} tarafından {new_account} adlı hesabın kaydı yapıldı",
        transfer: "{from} tarafından {to} adlı hesaba {amount} gönderildi",
        ...
        asset_issue: "{account} {amount} kadar miktarı {to} adlı hesaba düzenledi",
        asset_create: "{account} {asset} adlı aktifi oluşturdu",
        asset_update: "{account}  {asset} adlı aktifi güncelledi",
        lifetime_upgrade_account: "{account} ömür-boyu üyeliğe yükseltildi",
        annual_upgrade_account: "{account} yıllık üyeliğe yükseltildi",
        unlisted_by: "{lister}  {listee} adlı hesabı listeden çıkardı",
        whitelisted_by: "{lister}  {listee} adlı hesabı beyaz listeye aldı",
        blacklisted_by: "{lister}  {listee} adlı hesabı kara-listeye aldı",
        transfer_account: "{account} adlı hesabın mülkiyeti {to} adlı hesaba devredildi.",
        asset_update_feed_producers: "{account} {asset} adlı aktifin yayın besleyicilerini güncelledi ",
        asset_fund_fee_pool: "{account} {asset}adlı aktife ait ücret havuzuna {amount} ekledi",
