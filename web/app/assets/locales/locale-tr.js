 module.exports = {
    ...
    gateway: {
        ...
        scan_qr: "QR Tara",
        calc: "Hesaplanıyor",
        choose_deposit: "Lütfen yatırmak istediğiniz coin türünü seçin",
        choose_withdraw: "Lütfen çekmek istediğiniz coin türünü seçin",
        deposit_to: "Lütfen %(asset)s adlı aktiflerinizi aşağıdaki adrese gönderin",
        asset_to_deposit: "Yatırılacak aktif türü:",
        asset_to_receive: "Alacağınız:",
        receive_account: "Alacak hesap:",
        deposit_summary: "Para yatırma özeti",
        deposit_inst: "Para yatırma talimatları",
        recent_deposit: "Son para yatırmaları",
        recent_withdraw: "Son para çekimleri",
        withdraw_summary: "Para çekim özeti",
        withdraw_inst: "Para çekim talimatları",
        withdraw_to: "Aşağıdaki butona tıklayarak %(asset)s adlı aktifler çekme işlemine başlayın",
